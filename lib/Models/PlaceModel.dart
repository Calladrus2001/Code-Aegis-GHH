...
class Result {
  ...
  factory Result.fromJson(Map<String, dynamic> json) => Result(
        ...
        plusCode: json["plus_code"] != null
            ...
            : PlusCode.fromJson({
                "compoundCode": "Not Available",
                "globalCode": "Not Available"
              }),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "more_opening_hours":
            List<dynamic>.from(moreOpeningHours!.map((x) => x)),
        "name": name,
...
enum Type { HEALTH, POINT_OF_INTEREST, ESTABLISHMENT, PHYSIOTHERAPIST, DOCTOR }
